...
from . import views, views_nonlegacy, views_nonvascular, views_nonlegacy2
from . import views_filtered, admin_lib ## checklist_wrk, checklist, checklist3,
from . import views_species_inids
...
##    path('gallery/checklist/<str:name>/', checklist.find_taxon),
    ...
    path('gallery/view2/<int:pnid>/', views_nonlegacy2.view_photo_records, {'legacy':False, "template":"photodb/photos/gallery_index2.htm", "public":False}), ## changed to False = simple
...
path('gallery/view/species/<int:pnid>/', views_species_inids.view_photo_records_species),
path('gallery/view/species/local/<int:pnid>/', views_species_inids.view_photo_records_species, {"template":"photodb/photos/gallery_thums_byinid_local.htm"}),
