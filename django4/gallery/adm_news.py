        ...
        if existed:
            ...
            if name in new_recs:
                ...
                try:
                    ...
                    meta = {}
                new_recs[name] = {"plant": plant, "existed":bool(is_old), "meta":meta, "images": [imid], "planted": planted}
                ##debug
                if not is_old:
                    addsp += 1
...
def update_images_new(pubdate="2023-08-06"): ## 2022-06-26 2023-06-08
    start = datetime.datetime.now()
...
def update_species_new(pubdate="2023-08-06"): ## 2022-06-26 ="2022-08-31" 2023-01-15 2023-04-23 2023-06-08
    start = datetime.datetime.now()
